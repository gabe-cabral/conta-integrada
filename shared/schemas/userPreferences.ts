...
import { userAuditableRecordWithIdSchema } from '../zod/zodBase';
...
export const userPreferenceSchema = userPreferenceBaseSchema.refine(
  (preference) => preference.currencies.includes(preference.defaultCurrency),
  {
